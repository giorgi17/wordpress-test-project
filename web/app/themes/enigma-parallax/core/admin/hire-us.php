<?php if (!function_exists('theme_hire_page')) {
	...
	$page1=add_theme_page(__('Welcome to Enigma Parallax', 'enigma-parallax'), __('<span style="color:#ffc94a">Hire Us</span>', 'enigma-parallax'), 'edit_theme_options', 'hire-page', 'theme_display_theme_info_page');
...
function theme_admin_info(){
	...
	wp_enqueue_style('hire',  get_stylesheet_directory_uri() .'/core/admin/admin.css');
