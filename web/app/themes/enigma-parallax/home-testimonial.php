		...
		<div class="row">
			<div class="col-sm-12">
				<div class="enigma_heading_title">
					<h3><?php echo esc_attr($wl_theme_options['testimonial_title']); ?></h3>		
				</div>
			</div>
		</div>
	</div>
<?php } ?>
	<div class="container">
		...
		<div class="col-md-3 enigma_testimonial  pull-left scrollimation scale-in d2">
			...
			<p><?php echo esc_attr($wl_theme_options['testimonial_desc_'.$i.'']); ?></p>
			<img src="<?php echo esc_url($wl_theme_options['testimonial_'.$i.'_img']); ?>" >
			<h3><?php echo esc_attr($wl_theme_options['testimonial_name_'.$i.'']); ?></h3>
			<span>( <?php echo esc_attr($wl_theme_options['testimonial_desti_'.$i.'']); ?> )</span>
		</div>
		<?php } ?>
		<?php } ?>
		</div>
